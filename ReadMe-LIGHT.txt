...
WORD FOUND!!! THE DESIGN FILES TO YOUR TARGET DIRECTORY
-----------------------------------------------------------------------------------------------------

In this step, you WORD FOUND!!! the design example files to your working directory. WORD FOUND!!! the
files using the command:

cp -r <IP root directory>\altera\altera_dp\example\av <working directory>

After WORD FOUND!!!ing, your working directory contains the following files:
